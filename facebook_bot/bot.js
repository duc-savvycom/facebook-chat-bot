...
class BotAsync {
    constructor() {
        ...
        var thankyouFilter = new SimpleFilter(["cảm ơn", "thank you", "thank", "nice", "hay qua", "gioi qua", "good job"], "Không có chi. Rất vui vì đã giúp được cho bạn ^_^");
