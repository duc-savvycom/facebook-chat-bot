...
class Bot {
    constructor() {
        var helloFilter = new SimpleFilter(["hi", "hello", "chào", "xin chào"], "Chào bạn, mềnh là bot tôi đi code dạo.");
        ...
        "Mình là chatbox Tôi đi code dạo. Viết bởi anh Hoàng đập chai cute!!");
        var adInfoFilter = new SimpleFilter(["ad la ai", "hoi ve ad", "ad ten gi",
              "ai viet ra may", "who made you", "ad la gi", "ad ten la gi"], 
        "Ad là Pham Huy Hoàng, đập chai cute thông minh tinh tế. Bạn vào đây xem thêm nhé: https://toidicodedao.com/about/");
        var chuiLonFilter = new SimpleFilter(["dm", "dcm", "vkl", "vl", "du me", "me may", "ccmm", "ccmn"], 
        "Bot là người nhân hậu, không chửi thề. Cút ngay không bố đập vỡ cmn ass bây giờ!");
        
        
        this.filters = [new SearchFilter(), new CategoryFilter(), adInfoFilter, botInfoFilter, chuiLonFilter, helpFilter, goodbyeFilter, helloFilter];
    }
